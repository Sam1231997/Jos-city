...
const Details3=()=>{
    ...
    return(
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-[4rem] mb-4">
            <div>
                <img src='/images/u2.png' alt="Hotel Image" className="w-full rounded-lg shadow-md"/>
            </div>
            <div>
                <h2 className="lg:text-[1.8rem] text-[1.15rem] font-bold lg:font-semibold lg:mt-4 mb-4">The Dwelling Place</h2>
                <div className="mb-4">
                    <h3 className="text-[.9rem] lg:text-lg font-semibold">POPULAR AMENITIES</h3>
                    <p className="text-[.85rem] lg:text-[1rem]">Prayer</p>
                </div>
                <div className="mb-4">
